...
class VDCaptureDriverScreen : public IVDCaptureDriver,
                              public IVDScreenGrabberCallback,
                              IVDTimerCallback,
                              IVDAudioGrabberCallbackWASAPI
{
...
public:
  ...
  {
    return nsVDCapture::kTunerInputUnknown;
  }
