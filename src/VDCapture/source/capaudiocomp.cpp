...
VDCaptureAudioCompFilter::VDCaptureAudioCompFilter() : mpCB(NULL) {}
...
void VDCaptureAudioCompFilter::Init(
  const WAVEFORMATEX *srcFormat,
  const WAVEFORMATEX *dstFormat,
...
void VDCaptureAudioCompFilter::CapProcessData(
  int         stream,
  const void *data,
  uint32      size,
  sint64      timestamp,
