...
public:
  ...
  virtual bool Intercept_WM_CHAR(WPARAM wParam, LPARAM lParam)
  {
    return false;
  }
  virtual bool Intercept_WM_KEYDOWN(WPARAM wParam, LPARAM lParam)
  {
    return false;
  }
  ...
  virtual bool Intercept_WM_SYSKEYDOWN(WPARAM wParam, LPARAM lParam)
  {
    return false;
  }
