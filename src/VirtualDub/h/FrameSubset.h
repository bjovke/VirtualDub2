...
public:
  ...
  {}
  bool operator==(const FrameSubsetNode &a) const
  {
    return start == a.start && len == a.len && bMask == a.bMask && source == a.source;
  }
...
public:
  ...
  bool empty() const
  {
    return mTimeline.empty();
  }
  iterator begin()
  {
    return mTimeline.begin();
  }
