...
public:
  ...
  virtual void BitBlt(PixCoord x2, PixCoord y2, const VBitmap *src, PixCoord x1, PixCoord y1, PixDim dx, PixDim dy)
    const;
  virtual void BitBltDither(
    PixCoord       x2,
    PixCoord       y2,
    const VBitmap *src,
    PixDim         x1,
    ...
    PixDim         dy,
    bool           to565) const;
  virtual void BitBlt565(PixCoord x2, PixCoord y2, const VBitmap *src, PixDim x1, PixDim y1, PixDim dx, PixDim dy)
    const;

  virtual bool BitBltXlat1(
    PixCoord       x2,
    PixCoord       y2,
    const VBitmap *src,
    PixCoord       x1,
  ...
  virtual bool StretchBltNearestFast(
    PixCoord       x1,
    PixCoord       y1,
    PixDim         dx,
    PixDim         dy,
  ...
  virtual bool StretchBltBilinearFast(
    PixCoord       x1,
    PixCoord       y1,
    PixDim         dx,
    PixDim         dy,
...
private:
  bool dualrectclip(PixCoord &x2, PixCoord &y2, const VBitmap *src, PixCoord &x1, PixCoord &y1, PixDim &dx, PixDim &dy)
    const;
};
