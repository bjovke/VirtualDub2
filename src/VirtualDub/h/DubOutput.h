...
public:
  ...
  virtual bool GetStreamControl(VDXStreamControl &sc)
  {
    return true;
  }
...
public:
  ...
  virtual bool AcceptsVideo()
  {
    return false;
  }
  virtual bool AcceptsAudio()
  {
    return false;
  }
  ...
  virtual bool IsVideoImageOutputEnabled()
  {
    return false;
  }
  virtual bool IsVideoImageOutputRequired()
  {
    return false;
  }
  virtual bool AreNullFramesAllowed()
  {
    return false;
  }
  virtual bool IsVideoCompressionEnabled()
  {
    return false;
  }
  virtual int GetVideoOutputFormatOverride(int last_format)
  {
    return 0;
  }

  virtual bool IsCompressedAudioAllowed()
  {
    return true;
  }
  virtual bool GetInterleavingOverride(DubAudioOptions &opt)
  {
    return false;
  }
  virtual bool IsNull()
...
public:
  ...
  void SetFilenamePattern(
    const wchar_t *pszSegmentPrefix,
    const wchar_t *pszSegmentSuffix,
    int            nMinimumDigits,
    int            startDigit);
...
public:
  VDAVIOutputSegmentedSystem(
    IVDDubberOutputSystem *pChildSystem,
  ...
  const char *    GetFormatName()
  {
    return mpChildSystem->GetFormatName();
  }
