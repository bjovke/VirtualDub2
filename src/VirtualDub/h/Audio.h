...
public:
  ...
  VDWaveFormat *GetFormat() const
  {
    return source->GetFormat();
  }
  long GetFormatLen() const
  {
    return source->GetFormatLen();
  }
