...
struct VDFilterFrameClientRequestAllocatorNode : public vdlist_node
{
  ...
  VDFilterFrameClientRequestAllocatorNode()
    : mbInAllocatorIdleList(false), mbInAllocatorActiveList(false), mAllocatorMagic(kAllocatorMagic)
  {}
#endif
};
...
class VDFilterFrameClientRequest : public VDFilterFrameClientRequestNode,
                                   public vdrefcounted<IVDFilterFrameClientRequest>,
                                   public VDFilterFrameClientRequestAllocatorNode
{
...
public:
  ...
  {
    mbStealable = stealable;
  }

  const VDFilterFrameRequestTiming &GetTiming() const
  {
    return mTiming;
  }
  void SetTiming(const VDFilterFrameRequestTiming &timing)
  {
    mTiming = timing;
  }
  ...
  uint32 GetBatchNumber() const
  {
    return mBatchNumber;
  }
  void SetBatchNumber(uint32 batch)
  {
    mBatchNumber = batch;
  }
  ...
  VDFilterFrameRequestError *GetError() const
  {
    return mpError;
  }
