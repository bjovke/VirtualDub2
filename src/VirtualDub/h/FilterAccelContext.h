...
public:
  ...
  uint32 VDXAPIENTRY CreateTexture2D(
    uint32                width,
    uint32                height,
    uint32                mipCount,
    VDXAFormat            format,
  ...
  uint32 VDXAPIENTRY CreateRenderTexture(
    uint32     width,
    uint32     height,
    uint32     borderWidth,
    uint32     borderHeight,
  ...
  void VDXAPIENTRY
                   SetTextureMatrix(uint32 coordIndex, uint32 textureHandle, float xoffset, float yoffset, const float uvMatrix[12]);
  void VDXAPIENTRY SetTextureMatrixDual(
    uint32 coordIndex,
