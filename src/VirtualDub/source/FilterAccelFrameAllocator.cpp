...
VDFilterAccelFrameAllocator::VDFilterAccelFrameAllocator()
  : mSizeRequired(0), mBorderWRequired(0), mBorderHRequired(0), mMinFrames(0), mMaxFrames(0x7fffffff),
    mAllocatedFrames(0), mAllocatedBytes(0), mActiveFrames(0), mActiveBytes(0), mTrimCounter(0), mTrimPeriod(0),
    mpAccelEngine(NULL)
{}
