...
VDFilterAccelUploader::VDFilterAccelUploader() : mProcessStatus(kProcess_Idle), mpLockedSrc(NULL) {}

VDFilterAccelUploader::~VDFilterAccelUploader() {}

void VDFilterAccelUploader::Init(
...
bool VDFilterAccelUploader::InitNewRequest(
