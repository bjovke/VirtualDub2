...
{
#define TABROW(x)                                                                                                \
  TABENT(x + 0), TABENT(x + 1), TABENT(x + 2), TABENT(x + 3), TABENT(x + 4), TABENT(x + 5), TABENT(x + 6),       \
    TABENT(x + 7), TABENT(x + 8), TABENT(x + 9), TABENT(x + 10), TABENT(x + 11), TABENT(x + 12), TABENT(x + 13), \
    TABENT(x + 14), TABENT(x + 15)
#define TABLE                                                                                                       \
  TABROW(0x00), TABROW(0x10), TABROW(0x20), TABROW(0x30), TABROW(0x40), TABROW(0x50), TABROW(0x60), TABROW(0x70),   \
    TABROW(0x80), TABROW(0x90), TABROW(0xA0), TABROW(0xB0), TABROW(0xC0), TABROW(0xD0), TABROW(0xE0), TABROW(0xF0), \
    TABROW(0x100), TABROW(0x110), TABROW(0x120)
...
template<int d0, int d1, int d2, int d3> struct VDDitherUtils
{
  enum
  {
    rb0 = d0 * 51 / 16,
  ...
  static void DoSpan8To8(uint8 *dstp, const uint8 *srcp, int w2, const uint8 *pLogPal, const uint8 *palette)
  {
    ...
    switch (w2 & 3)
    {
      do
      {
        case 0:
          p        = &palette[4 * srcp[0]];
          dstp[w2] = pLogPal[rdithertab8[rb0 + p[2]] + gdithertab8[g0 + p[1]] + bdithertab8[rb0 + p[0]]];
        case 1:
          p            = &palette[4 * srcp[1]];
          dstp[w2 + 1] = pLogPal[rdithertab8[rb1 + p[2]] + gdithertab8[g1 + p[1]] + bdithertab8[rb1 + p[0]]];
        case 2:
          p            = &palette[4 * srcp[2]];
          dstp[w2 + 2] = pLogPal[rdithertab8[rb2 + p[2]] + gdithertab8[g2 + p[1]] + bdithertab8[rb2 + p[0]]];
        case 3:
          p            = &palette[4 * srcp[3]];
          dstp[w2 + 3] = pLogPal[rdithertab8[rb3 + p[2]] + gdithertab8[g3 + p[1]] + bdithertab8[rb3 + p[0]]];
    ...
    switch (w2 & 3)
    {
      do
      {
        case 0:
          px       = srcp[0];
          dstp[w2] = pLogPal
            [rdithertab8[rb0 + ((px & 0x7c00) >> 7)] + gdithertab8[g0 + ((px & 0x03e0) >> 2)] +
             bdithertab8[rb0 + ((px & 0x001f) << 3)]];
        case 1:
          px           = srcp[1];
          dstp[w2 + 1] = pLogPal
            [rdithertab8[rb1 + ((px & 0x7c00) >> 7)] + gdithertab8[g1 + ((px & 0x03e0) >> 2)] +
             bdithertab8[rb1 + ((px & 0x001f) << 3)]];
        case 2:
          px           = srcp[2];
          dstp[w2 + 2] = pLogPal
            [rdithertab8[rb2 + ((px & 0x7c00) >> 7)] + gdithertab8[g2 + ((px & 0x03e0) >> 2)] +
             bdithertab8[rb2 + ((px & 0x001f) << 3)]];
        case 3:
          px           = srcp[3];
          dstp[w2 + 3] = pLogPal
            [rdithertab8[rb3 + ((px & 0x7c00) >> 7)] + gdithertab8[g3 + ((px & 0x03e0) >> 2)] +
             bdithertab8[rb3 + ((px & 0x001f) << 3)]];
    ...
    switch (w2 & 3)
    {
      do
      {
        case 0:
          px       = srcp[0];
          dstp[w2] = pLogPal
            [rdithertab8[rb0 + ((px & 0xf800) >> 8)] + gdithertab8[g0 + ((px & 0x07e0) >> 3)] +
             bdithertab8[rb0 + ((px & 0x001f) << 3)]];
        case 1:
          px           = srcp[1];
          dstp[w2 + 1] = pLogPal
            [rdithertab8[rb1 + ((px & 0xf800) >> 8)] + gdithertab8[g1 + ((px & 0x07e0) >> 3)] +
             bdithertab8[rb1 + ((px & 0x001f) << 3)]];
        case 2:
          px           = srcp[2];
          dstp[w2 + 2] = pLogPal
            [rdithertab8[rb2 + ((px & 0xf800) >> 8)] + gdithertab8[g2 + ((px & 0x07e0) >> 3)] +
             bdithertab8[rb2 + ((px & 0x001f) << 3)]];
        case 3:
          px           = srcp[3];
          dstp[w2 + 3] = pLogPal
            [rdithertab8[rb3 + ((px & 0xf800) >> 8)] + gdithertab8[g3 + ((px & 0x07e0) >> 3)] +
             bdithertab8[rb3 + ((px & 0x001f) << 3)]];
  ...
  static void DoSpan24To8(uint8 *dstp, const uint8 *srcp, int w2, const uint8 *pLogPal)
  {
    switch (w2 & 3)
    {
      ...
      {
        case 0:
          dstp[w2] = pLogPal[rdithertab8[rb0 + srcp[2]] + gdithertab8[g0 + srcp[1]] + bdithertab8[rb0 + srcp[0]]];
        case 1:
          dstp[w2 + 1] = pLogPal[rdithertab8[rb1 + srcp[5]] + gdithertab8[g1 + srcp[4]] + bdithertab8[rb1 + srcp[3]]];
        case 2:
          dstp[w2 + 2] = pLogPal[rdithertab8[rb2 + srcp[8]] + gdithertab8[g2 + srcp[7]] + bdithertab8[rb2 + srcp[6]]];
        case 3:
          dstp[w2 + 3] = pLogPal[rdithertab8[rb3 + srcp[11]] + gdithertab8[g3 + srcp[10]] + bdithertab8[rb3 + srcp[9]]];
    ...
    switch (w2 & 3)
    {
      do
      {
        case 0:
          dstp[w2] = pLogPal[rdithertab8[rb0 + srcp[2]] + gdithertab8[g0 + srcp[1]] + bdithertab8[rb0 + srcp[0]]];
        case 1:
          dstp[w2 + 1] = pLogPal[rdithertab8[rb1 + srcp[6]] + gdithertab8[g1 + srcp[5]] + bdithertab8[rb1 + srcp[4]]];
        case 2:
          dstp[w2 + 2] = pLogPal[rdithertab8[rb2 + srcp[10]] + gdithertab8[g2 + srcp[9]] + bdithertab8[rb2 + srcp[8]]];
        case 3:
          dstp[w2 + 3] =
            pLogPal[rdithertab8[rb3 + srcp[14]] + gdithertab8[g3 + srcp[13]] + bdithertab8[rb3 + srcp[12]]];
...
void VDDitherImage8To8(VDPixmap &dst, const VDPixmap &src, const uint8 *pLogPal, const uint8 *palette)
{
  ...
  do
  {
    ...
    {
      case 0:
        VDDitherUtils<0, 8, 2, 10>::DoSpan8To8(dstp, srcp, w2, pLogPal, palette);
        break;
      case 1:
        VDDitherUtils<12, 4, 14, 6>::DoSpan8To8(dstp, srcp, w2, pLogPal, palette);
        break;
      case 2:
        VDDitherUtils<3, 11, 1, 9>::DoSpan8To8(dstp, srcp, w2, pLogPal, palette);
        break;
      case 3:
        VDDitherUtils<15, 7, 13, 5>::DoSpan8To8(dstp, srcp, w2, pLogPal, palette);
        break;
    }
...
void VDDitherImage15To8(VDPixmap &dst, const VDPixmap &src, const uint8 *pLogPal)
{
  ...
  do
  {
    ...
    {
      case 0:
        VDDitherUtils<0, 8, 2, 10>::DoSpan15To8(dstp, srcp, w2, pLogPal);
        break;
      case 1:
        VDDitherUtils<12, 4, 14, 6>::DoSpan15To8(dstp, srcp, w2, pLogPal);
        break;
      case 2:
        VDDitherUtils<3, 11, 1, 9>::DoSpan15To8(dstp, srcp, w2, pLogPal);
        break;
      case 3:
        VDDitherUtils<15, 7, 13, 5>::DoSpan15To8(dstp, srcp, w2, pLogPal);
        break;
    }
...
void VDDitherImage16To8(VDPixmap &dst, const VDPixmap &src, const uint8 *pLogPal)
{
  ...
  do
  {
    ...
    {
      case 0:
        VDDitherUtils<0, 8, 2, 10>::DoSpan16To8(dstp, srcp, w2, pLogPal);
        break;
      case 1:
        VDDitherUtils<12, 4, 14, 6>::DoSpan16To8(dstp, srcp, w2, pLogPal);
        break;
      case 2:
        VDDitherUtils<3, 11, 1, 9>::DoSpan16To8(dstp, srcp, w2, pLogPal);
        break;
      case 3:
        VDDitherUtils<15, 7, 13, 5>::DoSpan16To8(dstp, srcp, w2, pLogPal);
        break;
    }
...
void VDDitherImage24To8(VDPixmap &dst, const VDPixmap &src, const uint8 *pLogPal)
{
  ...
  do
  {
    ...
    {
      case 0:
        VDDitherUtils<0, 8, 2, 10>::DoSpan24To8(dstp, srcp, w2, pLogPal);
        break;
      case 1:
        VDDitherUtils<12, 4, 14, 6>::DoSpan24To8(dstp, srcp, w2, pLogPal);
        break;
      case 2:
        VDDitherUtils<3, 11, 1, 9>::DoSpan24To8(dstp, srcp, w2, pLogPal);
        break;
      case 3:
        VDDitherUtils<15, 7, 13, 5>::DoSpan24To8(dstp, srcp, w2, pLogPal);
        break;
    }
...
void VDDitherImage32To8(VDPixmap &dst, const VDPixmap &src, const uint8 *pLogPal)
{
  ...
  do
  {
    ...
    {
      case 0:
        VDDitherUtils<0, 8, 2, 10>::DoSpan32To8(dstp, srcp, w2, pLogPal);
        break;
      case 1:
        VDDitherUtils<12, 4, 14, 6>::DoSpan32To8(dstp, srcp, w2, pLogPal);
        break;
      case 2:
        VDDitherUtils<3, 11, 1, 9>::DoSpan32To8(dstp, srcp, w2, pLogPal);
        break;
      case 3:
        VDDitherUtils<15, 7, 13, 5>::DoSpan32To8(dstp, srcp, w2, pLogPal);
        break;
    }
...
VDVideoDisplayMinidriver::VDVideoDisplayMinidriver()
  : mbDisplayDebugInfo(false), mbHighPrecision(false), mbDestRectEnabled(false), mClientRect(0, 0, 0, 0),
    mDestRect(0, 0, 0, 0), mDrawRect(0, 0, 0, 0), mBackgroundColor(0), mColorOverride(0), mPixelSharpnessX(1.0f),
    mPixelSharpnessY(1.0f), mpCompositor(NULL), mhClipRgn(0)
{}
