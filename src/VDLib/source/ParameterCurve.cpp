...
VDParameterCurve::VDParameterCurve() : mMinVal(-1e+30f), mMaxVal(1e+30f), mRefCount(0) {}

VDParameterCurve::VDParameterCurve(const VDParameterCurve &a)
  : mMinVal(a.mMinVal), mMaxVal(a.mMaxVal), mRefCount(0), mPoints(a.mPoints)
{}
...
VDParameterCurve::PointList::iterator VDParameterCurve::GetNearestPoint2D(
  double x,
  double y,
  double xRadius,
  double yScale)
{
  return mPoints.begin() +
         (static_cast<const VDParameterCurve *>(this)->GetNearestPoint2D(x, y, xRadius, yScale) - mPoints.begin());
}

VDParameterCurve::PointList::const_iterator VDParameterCurve::GetNearestPoint2D(
  double x,
  double y,
  double xRadius,
  double yScale) const
