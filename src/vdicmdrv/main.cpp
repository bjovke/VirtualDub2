  ...
  do
  {
    if (cur_id != BOGUS_DRIVER_ID && cur_id)
    {
      if (!find_xlator_by_id16(cur_id))
      {
        ...
        if (!(dpt = new DriverPtrTranslator))
          return 0;
...
{
  if (dpt == active_opens)
    active_opens = dpt->next;
  if (dpt->prev)
    dpt->prev->next = dpt->next;
  if (dpt->next)
    dpt->next->prev = dpt->prev;
...
extern "C" __declspec(dllexport) LRESULT CALLBACK
  DriverProc(DWORD_PTR dwDriverID, HDRVR hDriver, UINT uiMessage, LPARAM lParam1, LPARAM lParam2)
{
  IVideoCompressor *pi;
  int               i;
  LRESULT           dw;
      ...
      if (pi && uiMessage >= DRV_USER)
        switch (uiMessage)
        {
          ...
          case ICM_COMPRESS_BEGIN:
            return pi->CompressBegin((LPBITMAPINFO)lParam1, (LPBITMAPINFO)lParam2);
          case ICM_COMPRESS_FRAMES_INFO:
            return pi->CompressFramesInfo((ICCOMPRESSFRAMES *)lParam1, (DWORD)lParam2);
          case ICM_COMPRESS_GET_FORMAT:
            return pi->CompressGetFormat((LPBITMAPINFO)lParam1, (LPBITMAPINFO)lParam2);
          case ICM_COMPRESS_GET_SIZE:
            return pi->CompressGetSize((LPBITMAPINFO)lParam1, (LPBITMAPINFO)lParam2);
          case ICM_COMPRESS_QUERY:
            return pi->CompressQuery((LPBITMAPINFO)lParam1, (LPBITMAPINFO)lParam2);
          case ICM_CONFIGURE:
            return pi->Configure((HWND)lParam1);
          case ICM_DECOMPRESS:
            return pi->Decompress((ICDECOMPRESS *)lParam1, (DWORD)lParam2);
          case ICM_DECOMPRESS_BEGIN:
            return pi->DecompressBegin((LPBITMAPINFO)lParam1, (LPBITMAPINFO)lParam2);
          case ICM_DECOMPRESS_END:
            return pi->DecompressEnd();
          case ICM_DECOMPRESS_GET_FORMAT:
            return pi->DecompressGetFormat((LPBITMAPINFO)lParam1, (LPBITMAPINFO)lParam2);
          case ICM_DECOMPRESS_GET_PALETTE:
            return pi->DecompressGetPalette((LPBITMAPINFOHEADER)lParam1, (LPBITMAPINFOHEADER)lParam2);
          case ICM_DECOMPRESS_QUERY:
            return pi->DecompressQuery((LPBITMAPINFO)lParam1, (LPBITMAPINFO)lParam2);
          case ICM_DECOMPRESS_SET_PALETTE:
            return pi->DecompressSetPalette((LPBITMAPINFOHEADER)lParam1);
          case ICM_DECOMPRESSEX:
            return pi->DecompressEx((ICDECOMPRESSEX *)lParam1, (DWORD)lParam2);
          case ICM_DECOMPRESSEX_BEGIN:
            return pi->DecompressExBegin((ICDECOMPRESSEX *)lParam1, (DWORD)lParam2);
          case ICM_DECOMPRESSEX_QUERY:
            return pi->DecompressExQuery((ICDECOMPRESSEX *)lParam1, (DWORD)lParam2);
          case ICM_DRAW:
            return pi->Draw((ICDRAW *)lParam1, (DWORD)lParam2);
          case ICM_DRAW_BEGIN:
            return pi->DrawBegin((ICDRAWBEGIN *)lParam1, (DWORD)lParam2);
          case ICM_DRAW_CHANGEPALETTE:
            return pi->DrawChangePalette((BITMAPINFO *)lParam1);
          case ICM_DRAW_END:
            return pi->DrawEnd();
          case ICM_DRAW_FLUSH:
            return pi->DrawFlush();
          case ICM_DRAW_GETTIME:
            return pi->DrawGetTime((DWORD *)lParam1);
          case ICM_DRAW_QUERY:
            return pi->DrawQuery((BITMAPINFO *)lParam1);
          case ICM_DRAW_REALIZE:
            return pi->DrawRealize((HDC)lParam1, (BOOL)lParam2);
          case ICM_DRAW_RENDERBUFFER:
            return pi->DrawRenderBuffer();
          case ICM_DRAW_SETTIME:
            return pi->DrawSetTime((DWORD)lParam1);
          case ICM_DRAW_START:
            return pi->DrawStart();
          case ICM_DRAW_START_PLAY:
            return pi->DrawStartPlay((DWORD)lParam1, (DWORD)lParam2);
          case ICM_DRAW_STOP:
            return pi->DrawStop();
          case ICM_DRAW_STOP_PLAY:
            return pi->DrawStopPlay();
          case ICM_DRAW_SUGGESTFORMAT:
            return pi->DrawSuggestFormat((ICDRAWSUGGEST *)lParam1, (DWORD)lParam2);
          case ICM_DRAW_WINDOW:
            return pi->DrawWindow((RECT *)lParam1);
          case ICM_GET:
            return pi->Get((LPVOID)lParam1, (DWORD)lParam2);
          case ICM_GETBUFFERSWANTED:
            return pi->GetBuffersWanted((DWORD *)lParam1);
          case ICM_GETDEFAULTKEYFRAMERATE:
            return pi->GetDefaultKeyFrameRate((DWORD *)lParam1);
          case ICM_GETDEFAULTQUALITY:
            return pi->GetDefaultQuality((DWORD *)lParam1);
          case ICM_GETINFO:
            return pi->GetInfo((ICINFO *)lParam1, (DWORD)lParam2);
          case ICM_GETQUALITY:
            return pi->GetQuality((DWORD *)lParam1);
          case ICM_GETSTATE:
            return pi->GetState((LPVOID)lParam1, (DWORD)lParam2);
          case ICM_SET_STATUS_PROC:
            return pi->SetStatusProc((ICSETSTATUSPROC *)lParam1, (DWORD)lParam2);
          case ICM_SETQUALITY:
            return pi->SetQuality((DWORD *)lParam1);
          case ICM_SETSTATE:
