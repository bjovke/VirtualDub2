...
#ifdef VD_CPU_X86
extern "C" void asm_grayscale_run(void *dst, unsigned long width, unsigned long height, unsigned long stride);
#endif
...
VDVFGrayscale::VDVFGrayscale() : mVDXAShader(0) {}
...
uint32 VDVFGrayscale::GetParams()
{
  ...
  return FILTERPARAM_SUPPORTS_ALTFORMATS | FILTERPARAM_PURE_TRANSFORM | FILTERPARAM_NORMALIZE16 |
         FILTERPARAM_ALIGN_SCANLINES_16;
}
