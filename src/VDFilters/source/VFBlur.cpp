...
VDVFilterBlur::VDVFilterBlur() : mAccelFP(0) {}
...
VDVFilterBlurHi::VDVFilterBlurHi() : mAccelFP(0) {}
...
extern const VDXFilterDefinition g_VDVFBlur =
  VDXVideoFilterDefinition<VDVFilterBlur>(NULL, "blur", "Applies a radius-1 gaussian blur to the image.");

extern const VDXFilterDefinition g_VDVFBlurHi =
  VDXVideoFilterDefinition<VDVFilterBlurHi>(NULL, "blur more", "Applies a radius-2 gaussian blur to the image.");
