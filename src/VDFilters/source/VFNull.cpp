...
public:
  ...
  VDVFNullDialog(IVDXFilterPreview2 *ifp2) : VDDialogFrameW32(IDD_FILTER_NULL), mifp2(ifp2) {}
...
extern const VDXFilterDefinition g_VDVFCrop = VDXVideoFilterDefinition<VDVFNull>(NULL, "crop", "Used for cropping.");
